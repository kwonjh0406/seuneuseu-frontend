  ...
  return (
    <div className="fixed left-0 flex flex-col h-full border-r bg-background z-50">
      <div className="w-[72px] lg:w-[245px] h-full py-4">
        <Link
          href="/"
          className="flex items-center px-6 py-2 mb-3"
        >
          <div className="relative w-7 h-7">
            ...
            <svg viewBox="0 0 120 28" height="28" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
              <text x="0" y="20" fontSize="27" fontFamily="Arial" fontWeight="bold" fill="black">스느스</text>
            </svg>
