...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center max-sm:-mt-14">
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-background px-2 text-gray-500 dark:text-gray-400">또는</span>
            </div>
          </div>

          <Link
            href="/"
            className="flex h-12 w-full items-center justify-center rounded-full border border-gray-200 dark:border-zinc-800 text-sm font-medium transition-colors hover:bg-gray-100 dark:hover:bg-zinc-900"
          >
            둘러보기
          </Link>
        </div>
